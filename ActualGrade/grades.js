...
async function main(){
    ...
    popup.innerHTML = `<div id="techpro-header"><table><tr><th>+Actual<span>Grade</span></th></tr>
                        ...
                        <tr><td id="header-course">${document.querySelector(".d2l-navigation-s-title-container").innerText}</td></tr></table>`;
    ...
    <h2>Unweighted Grade</h2>
    <p><span class="main-grade">${gradeData.calculated.letter}</span> <span class="main-percentage">(${gradeData.calculated.percentage})</span></p>
    <h2>Unweighted Zeroed Grade</h2>
    <p><span class="main-grade">${gradeData.zeroed.letter}</span> <span class="main-percentage">(${gradeData.zeroed.percentage})</span></p>
    <h2>Unweighted Non-zeroed Grade</h2>
...
async function getGrade(id){
    ...
    let table = courseHTML.querySelector(".d2l-table").children[0];
