(self.webpackChunk = self.webpackChunk || []).push([[805], {
    ...
    Fna7: (t,e,n)=>{
        ...
        const g = {
            ...
            r.N1)(t, e),
            showMicMuteBanner: ()=>(0,
            h.wN)(u.Z.notification.container.STAGE, {
                id: "mic_state-you_are_muted_raise_hand",
                title: A.Z.t("clickToUnmuteHandRaise"),
                type: "dark",
                actionButtons: [],
                timeout: 4
            }, !1)
    ...
    WIpW: (t,e,n)=>{
                ...
                c.jsxs)("div", {
                    ...
                    c.jsxs)("div", {
                        ...
                        c.jsx)("div", {
                            ...
                            children: t.time ? "" + u()(t.time).format("hh:mm A") : ""
                        })]
                    }), (0,
                    c.jsxs)("div", {
        ...
        s.$j)((()=>{
          ...
          , y = i.memo((({participant: t, handleParticipantClick: e, cdn: n})=>{
            ...
            return (0,
            c.jsxs)("li", {
                className: r()(C["participant-container"]),
                onClick: e.bind(null, t),
                children: [(0,
                c.jsx)("div", {
        ...
        s.$j)((function(t) {
            const {chat: e, settings: n} = t
              , {participants: i} = t
              , s = (0,
            V.Hw)(i.list ? i.list : {}, n.generalSettings, n.roomData, U(n.ownData), e.search.term);
            return {
                searchTerm: (0,
                V.aX)(t),
                participants: s,
        ...
        var Mt = function(t) {
            function e() {
                ...
                i.handleClick = function(t) {
                    ...
                    i.props.disabled || i.props.divider || (Ct(i.props.onClick, t, ft()({}, i.props.data, vt.data), vt.target),
            ...
            Ot(e, [{
                key: "render",
                value: function() {
                    var t, e = this, n = this.props, s = n.attributes, o = n.children, a = n.className, p = n.disabled, c = n.divider, l = n.selected, d = r()(a, "react-contextmenu-item", s.className, (It(t = {}, r()("react-contextmenu-item--disabled", s.disabledClassName), p),
                    It(t, r()("react-contextmenu-item--divider", s.dividerClassName), c),
                    It(t, r()("react-contextmenu-item--selected", s.selectedClassName), l),
                    t));
        ...
        var Vt = function(t) {
            function e(t) {
                ...
                n.handleClick = function(t) {
                    t.preventDefault(),
                    n.props.disabled || (Ct(n.props.onClick, t, ft()({}, n.props.data, vt.data), vt.target),
          ...
          , zt = function(t) {
            function e(t) {
                ...
                n.handleMouseLeave = function(t) {
                    t.preventDefault(),
                    Ct(n.props.onMouseLeave, t, ft()({}, n.props.data, vt.data), vt.target),
            ...
            Ft(e, [{
                ...
                key: "render",
                value: function() {
                    var t, e, n, s = this.props, o = s.children, a = s.className, p = s.style, c = this.state.isVisible, l = ft()({}, p, {
                        position: "fixed",
                        opacity: 0,
                        pointerEvents: "none"
        ...
        var Yt = function(t) {
            function e() {
                ...
                for (var s = arguments.length, o = Array(s), r = 0; r < s; r++)
                    o[r] = arguments[r];
                return n = i = qt(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(o))),
                i.touchHandled = !1,
                i.handleMouseDown = function(t) {
                    ...
                    Ct(i.props.attributes.onMouseDown, t)
                }
                ,
                i.handleMouseUp = function(t) {
                    0 === t.button && clearTimeout(i.mouseDownTimeoutId),
                    Ct(i.props.attributes.onMouseUp, t)
                }
                ,
                i.handleMouseOut = function(t) {
                    0 === t.button && clearTimeout(i.mouseDownTimeoutId),
                    Ct(i.props.attributes.onMouseOut, t)
                }
                ,
                ...
                i.handleContextClick = function(t) {
                    if (!(i.props.disable || i.props.disableIfShiftIsPressed && t.shiftKey)) {
                        ...
                        St();
                        var s = Ct(i.props.collect, i.props)
                          , o = {
                            position: {
                                x: e,
                                y: n
        ...
        var Xt = n("sATW")
          , te = n("fIjO");
        const ee = i.memo((({t, isRecived: e=!1, message: n, continuedMessage: s=!1, noStyle: o=!1, disableMenu: a=!1, className: l, reply: d=!1, isInInput: h=!1, onRemoveReplyClicked: u, fontScale: A=100, showQnAReplyButtons: m, shouldStretch: g, onReplyClicked: f, wasAnswered: C})=>{
            const b = i.createRef();
            return (0,
            c.jsxs)(Kt, {
                id: "message-menu",
                ...
                c.jsx)("p", {
                    ...
                    style: {
                        fontSize: d ? 14 * Number(A / 100) : 17 * Number(A / 100)
                    },
                    children: (0,
        ...
        var ae = n("svWY")
          , pe = n("PffM");
        const ce = class extends i.Component {
            constructor(t) {
                super(t),
                this.state = {
                    currMessages: [],
        ...
        var fe, Ce, be = i.forwardRef((function(t, e) {
            var n = t.title
              , s = t.titleId
              , o = function(t, e) {
                if (null == t)
            ...
            return i.createElement("svg", ge({
                ...
                id: s
            }, n) : null, Ae || (Ae = i.createElement("g", {
                id: "_x33_r6LBk.tif"
        ...
        var we, ye, xe = i.forwardRef((function(t, e) {
            ...
            return i.createElement("svg", ve({
                ...
                id: s
            }, n) : null, fe || (fe = i.createElement("g", {
                id: "_x33_r6LBk.tif"
            })), Ce || (Ce = i.createElement("g", {
                id: "_x33_r6LBk.tif_1_"
            })), i.createElement("path", {
                id: "Shape_3781_copy_2",
                style: {
        ...
        var ke, Se, Ee, Be, Oe, Ie, Ne = i.forwardRef((function(t, e) {
            var n = t.title
              , s = t.titleId
              , o = function(t, e) {
                if (null == t)
        ...
        const Re = {
            ...
            [E.Z.conversationTypes.qna]: {
                fill: i.forwardRef((function(t, e) {
                    ...
                    return i.createElement("svg", Pe({
                        ...
                        id: s
                    }, n) : null, Oe || (Oe = i.createElement("g", {
                        id: "_x33_r6LBk.tif"
                    })), Ie || (Ie = i.createElement("g", {
                        id: "_x33_r6LBk.tif_1_"
                    })), i.createElement("path", {
                        id: "Shape_3781_copy_2",
                        style: {
          ...
          , je = i.memo((({chats: t, currentConv: e, handleChangingConversation: n, cdn: i, isRoomThemeConf: s, ownId: o})=>(0,
        c.jsx)("div", {
            ...
            children: t && t.map((t=>{
                ...
                c.jsx)(ue, {
                    ...
                    }) : s ? Re[t.conversation_type] && Re[t.conversation_type].custom : e.id === t.id ? Re[t.conversation_type] && Re[t.conversation_type].noFill : Re[t.conversation_type] && Re[t.conversation_type].fill,
        ...
        s.$j)((t=>{
            ...
            return {
                participants: He(e),
                hideNewFeatures: Ue(n.generalSettings),
            ...
            handlePrivateChat(t, e) {
                this.props.changeCurrConversation && I({
        ...
        var Je = i.forwardRef((function(t, e) {
            ...
            return i.createElement("svg", Qe({
                ...
                id: s
            }, n) : null, Ye || (Ye = i.createElement("defs", null, i.createElement("style", null, ".a{fill:#101b21;}"))), Ke || (Ke = i.createElement("path", {
                className: "a",
        ...
        Cn.UU)("conversationId")], ((t,e)=>{
          ...
          , wn = {
            ...
            receiveMessage: ({dispatch: t},e)=>{
                ...
                fn.F.actionReceived(E.Z.genericEventModule.NOTIFICATION, E.Z.genericEventAction.showChatNotification, e)
            }
            ,
        ...
        s.$j)((t=>{
            ...
            V.OH)(s, e.notifications.conversationId),
            o = (0,
            V.hD)(e.notifications));
            const r = i.list ? i.list : {}
              , a = Bn(n.ownData)
              , p = (0,
            ct.S_)(r, a)
              , c = r[a]
              , l = On(n.generalSettings);
            return {
                fontSize: (0,
                V.tb)(t),
                conversations: (0,
                V.yg)(t),
                unreadMessages: (0,
                V.vq)(s.conversations),
                currConv: (0,
                V.mA)(s),
                hasCurrentConversationAccess: (0,
                V._U)((0,
                V.mA)(e.conversations), n.generalSettings, c, p),
            ...
            handleSearchItemClicked(t) {
                this.props.conversations[t.user_id] || (I({
    ...
    "9Nti": (t,e,n)=>{
        ...
        i.P1)(h, (t=>t.conversations.conversations))
          ...
          , f = t=>t.settings.ownData.user_id
          , C = (0,
        i.P1)(g, f, ((t,e)=>$(t[e])))
          , b = (0,
        i.P1)(g, f, ((t,e)=>t[e]))
        ...
        i.P1)((t=>t.settings && t.settings.generalSettings && t.settings.generalSettings.chat_module && t.settings.generalSettings.chat_module.default_settings && t.settings.generalSettings.chat_module.default_settings.moderator_chat), (t=>t === a.Z.permissionValues.ON))
          , E = (0,
        i.P1)(m, k, y, C, c.oh, S, ((t,e,n,i,s,o)=>!!t && Object.keys(t).filter((r=>{
            const p = t[r];
        ...
        i.P1)(B, m, ((t,e)=>e && t.sort(((t,n)=>e[n].lastMessage && e[n].lastMessage.timestamp ? e[t].lastMessage && e[t].lastMessage.timestamp ? e[n].lastMessage.timestamp - e[t].lastMessage.timestamp : 0 : 1))))
          , I = d((0,
        i.P1)(E, O, ((t,e)=>t && e && [].concat(t).concat(e))), m, ((t,e)=>e && t && t.map((t=>{
            const n = e[t];
            return {
                id: t,
                name: n.name,
    ...
    "+0J0": (t,e,n)=>{
        ...
        const m = new (n("4AhL").u)({
          ...
          , g = {
            ...
            closeNotesModule: function(t, e) {
                e ? t.dispatch((0,
                A.Z6)(e.moduleName)) : m.error("Received notes legacy event but no payload present. eventName: closeNotesModule")
            },
        ...
        const C = {
            subscribedToNote: function(t, e) {
                e ? f.S.actionReceived("subscribeToNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: subscribedToNote")
            },
            subscribeToNote: function(t, e) {
                e ? f.S.actionReceived("subscribeToNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: subscribeToNote")
            },
            notesToListenersSent: function(t, e) {
                e ? f.S.actionReceived("sendNotesToListeners", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: notesToListenersSent")
            },
            sendNotesToListeners: function(t, e) {
                e ? f.S.actionReceived("sendNotesToListeners", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: sendNotesToListeners")
            },
            createdNotesSent: function(t, e) {
                e ? f.S.actionReceived("handleCreateNote", e.newNote) : m.error("Received notes event from RS but no payload present. eventName: createdNotesSent")
            },
            sendCreatedNote: function(t, e) {
                e ? f.S.actionReceived("handleCreateNote", e.newNote) : m.error("Received notes event from RS but no payload present. eventName: sendCreatedNote")
            },
            renameSent: function(t, e) {
                e ? f.S.actionReceived("handleReceivedNewName", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: renameSent")
            },
            sendRename: function(t, e) {
                e ? f.S.actionReceived("handleReceivedNewName", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: sendRename")
            },
            deletedNoteSent: function(t, e) {
                e ? f.S.actionReceived("handleDeleteNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: deletedNoteSent")
            },
            sendDeletedNote: function(t, e) {
                e ? f.S.actionReceived("handleDeleteNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: sendDeletedNote")
            },
            noteBroadcastedToAll: function(t, e) {
                e ? f.S.actionReceived("handleBroadcastNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: noteBroadcastedToAll")
            },
            broadcastNoteToAll: function(t, e) {
                e ? f.S.actionReceived("handleBroadcastNote", e.eventData) : m.error("Received notes event from RS but no payload present. eventName: broadcastNoteToAll")
            }
        };
        var b = n("svWY")
          , v = n("6jGC")
    ...
    fS4U: (t,e,n)=>{
        ...
        d.$j)((t=>{
            ...
            handleStandardMuteAllNotifications(t) {
                ...
                m.wN)(s.Z.notification.container.STAGE, {
                    id: t.media_type + "-device",
                    title: this.props.t(t.media_type === s.Z.mediaStateTypes.mic_state ? "participantsMicsMuted" : "participantsCamsDisabled"),
                    actionButtons: [],
                    hideCloseButton: !0,
                    type: s.Z.notification.type.DARK,
                    timeout: 6
    ...
    "2vZU": (t,e,n)=>{
        ...
        var u, A = s.forwardRef((function(t, e) {
            var n = t.title
              , o = t.titleId
              , r = function(t, e) {
                if (null == t)
        ...
        var ut = s.forwardRef((function(t, e) {
            var n = t.title
              , i = t.titleId
              , o = function(t, e) {
                if (null == t)
        ...
        f.ib)(t, [c.Z.liveMediaState.LIVE_INIT, c.Z.liveMediaState.LIVE_SUCCESS]))) : []], (t=>t))
          , jt = (0,
        E.P1)([Rt], (t=>t.length))
          , Tt = (0,
        E.P1)([Rt, (t,e)=>(0,
        ...
        o.$j)((()=>{
            ...
            return (e,n)=>{
                ...
                y.eW)(e, n)
                  , u = (0,
                St._W)(e)
                  , A = Zt(e, e.settings.ownData, n.participantId)
                  , m = (0,
                kt.c2)(e, n);
                return {
                    participant: a,
            ...
            dispatchParticipantLiveStateChange() {
                ...
                f.ib)(this.props.participant, [c.Z.liveMediaState.UNLIVE]) && this.props.liveParticipant && this.props.liveParticipantsCount >= c.Z.maxStreamsInCarousel && this.props.dispatch((0,
            ...
            componentDidMount() {
                Ct.F.addOnEventReceivedListener(c.Z.modules.roomParticipants, this.dominantSpeakerChanged),
            ...
            componentWillUnmount() {
                Ct.F.removeOnEventReceivedListener(c.Z.modules.roomParticipants, this.dominantSpeakerChanged)
            }
            componentDidUpdate(t, e, n) {
            ...
            renderParticipantsStreamingButtons() {
                const {participant: t} = this.props
                  ...
                  , r = t && (t.live_media_state === c.Z.liveMediaState.LIVE_INIT || t.live_media_state === c.Z.liveMediaState.DISABLED) && "" + t.user_id != "" + this.props.ownUserId
                  , a = this.userInBreakout()
                  , l = a || r
                  , h = a || !e
                  , u = a || !n
                  , A = d()("participant-media-control-container", {
                  ...
                  , m = d()("participant-media-control-container", {
                    ...
                    "participant-media-control-disabled": u,
                  ...
                  , f = this.props.t(o && !a ? "unsetLive" : "setLive")
            ...
            getUserAvatar() {
                ...
                f.bN)(this.props.cdn, this.props.participant.avatar) : ""
            }
            userInBreakout() {
        ...
        var Vt, Ut = n("h5V4"), Ft = n("k6h8"), zt = n("+5C1");
        function Ht() {
            return (Ht = Object.assign || function(t) {
                for (var e = 1; e < arguments.length; e++) {
                    var n = arguments[e];
        ...
        var Gt, Wt, qt, Yt, Kt = s.forwardRef((function(t, e) {
            var n = t.title
              , i = t.titleId
              , o = function(t, e) {
                if (null == t)
            ...
            return s.createElement("svg", Ht({
                ...
                id: i
            }, n) : null, Vt || (Vt = s.createElement("path", {
        ...
        o.$j)((function(t) {
            ...
            return {
                ...
                roomType: ue(e.roomData),
                platformType: Ae(e.browserInfo),
                isAdmin: p,
                ownId: s
            }
        }
            ...
            dispatchMuteAll() {
                ...
                Ut.eO)(!this.props.muteState) : (0,
                Ut.om)(c.Z.mediaStateTypes.mic_state, this.props.ownId))
            }
            dispatchCameraOffAll() {
                this.props.dispatch(this.props.hardMuteEnabled ? (0,
                Ut.zw)(!this.props.camState) : (0,
                Ut.om)(c.Z.mediaStateTypes.webcam_state, this.props.ownId))
            }
            ...
            changeRoomDefaultPermissions(t, e, n) {
                this.props.dispatch((0,
                Ut.a1)(this.props.room_id, t, e, n === c.Z.permissionValues.ON ? c.Z.permissionValues.OFF : c.Z.permissionValues.ON))
            }
            isSettingsVisibleForUser() {
                return this.props.settingsVisibility && this.props.settingsVisibility !== c.Z.permissionValues.ON ? this.props.settingsVisibility !== c.Z.permissionValues.OFF && (this.props.settingsVisibility === c.Z.moduleVisibilityValues.ADMIN_ONLY.toLowerCase() ? this.props.isAdmin : this.props.isModerator) : this.props.isModerator
            }
        ...
        o.$j)((function(t) {
            ...
            componentDidMount() {
                if (this.props.participants) {
                    const t = Object.keys(this.props.participants).length;
                    this.props.changeCounter(t),
                    this.props.changeHasCounterWarning(!!this.props.roomCapacity && t >= Number(this.props.roomCapacity))
                }
                this.setDropdown(),
            ...
            componentDidUpdate(t, e, n) {
                if (this.props.participants) {
                    const t = this.props.participants.length;
                    this.props.changeCounter(t),
                    this.setShouldCloseOnContentClick(),
                    this.props.changeHasCounterWarning(!!this.props.roomCapacity && t >= Number(this.props.roomCapacity))
                }
    ...
    E6V6: (t,e,n)=>{
        ...
        a.$j)((function(t) {
            ...
            onConfirmEndSession() {
                ...
                this.props.contentType === u.Z.activeContentTypes.desktopShare && (0,
    ...
    RBRZ: function(t) {
        t.exports = function() {
            ...
            var w = function() {
                ...
                ,
                u.isSame = function(t, e) {
                    var n = b(t);
                    return this.startOf(e) <= n && n <= this.endOf(e)
                }
                ,
                u.isAfter = function(t, e) {
                    return b(t) < this.startOf(e)
                }
                ,
                u.isBefore = function(t, e) {
                ...
                ,
                u.$set = function(o, a) {
                    var l, d = v.p(o), h = "set" + (this.$u ? "UTC" : ""), u = (l = {},
                    l[s] = h + "Date",
                    l[c] = h + "Date",
                    l[r] = h + "Month",
                    l[p] = h + "FullYear",
                ...
                ,
                u.diff = function(t, c, l) {
                    var d, h = v.p(c), u = b(t), A = 6e4 * (u.utcOffset() - this.utcOffset()), m = this - u, g = v.m(this, u);
                    return g = (d = {},
                    d[p] = g / 12,
                    d[r] = g,
                    d[a] = g / 3,
    ...
    L8dN: (t,e,n)=>{
        ...
        var g = function(t) {
            ...
            function p(t) {
                ...
                m(u(e = r.call(this, t)), "onWork", (function(t) {
                    var n = t.isOpened
                      , i = l(t, ["isOpened"]);
                    e.setState({
                        isResting: !1,
                ...
                m(u(e), "getInitialStyle", (function() {
                    var t = e.state;
...
//# sourceMappingURL=805.4c50e0d51fd2c3bf19f6.esm.js.map
